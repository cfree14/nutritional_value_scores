...
d <- read.csv("Data/FCD_16Feb2024.csv")
...
d[d$Food_long == "Milk (cow), dry, whole, without added vitamin D",5:44] <- sweep(d[, 5:44], 1, 496/61, FUN = "/")[d$Food_long == "Milk (cow), dry, whole, without added vitamin D", ]
...
d$V <- ifelse(d$Food_long == "Milk (cow), dry, whole, without added vitamin D" | d$Food_long == "Milk (cow), whole, 3.25% milkfat, without added vitamin A and vitamin D" | d$Food_long == "Milk, sheep/goat, fluid, whole, unenriched" | d$Food_long == "Yogurt, plain, whole milk" | d$Food_long == "Soymilk, original and vanilla, unfortified" | d$Food_long == "Cottage cheese, farmer's (low-fat)", d$V_E, d$V)
...
d$M <- ifelse(d$Food_long == "Milk (cow), dry, whole, without added vitamin D" | d$Food_long == "Milk (cow), whole, 3.25% milkfat, without added vitamin A and vitamin D" | d$Food_long == "Milk, sheep/goat, fluid, whole, unenriched" | d$Food_long == "Yogurt, plain, whole milk" | d$Food_long == "Soymilk, original and vanilla, unfortified" | d$Food_long == "Cottage cheese, farmer's (low-fat)", d$M_E, d$M)
...
d$N3 <- ifelse(d$Food_long == "Milk (cow), dry, whole, without added vitamin D" | d$Food_long == "Milk (cow), whole, 3.25% milkfat, without added vitamin A and vitamin D" | d$Food_long == "Milk, sheep/goat, fluid, whole, unenriched" | d$Food_long == "Yogurt, plain, whole milk" | d$Food_long == "Soymilk, original and vanilla, unfortified" | d$Food_long == "Cottage cheese, farmer's (low-fat)", d$N3_E, d$N3)
...
d$eaa <- ifelse(d$Food_long == "Milk (cow), dry, whole, without added vitamin D" | d$Food_long == "Milk (cow), whole, 3.25% milkfat, without added vitamin A and vitamin D" | d$Food_long == "Milk, sheep/goat, fluid, whole, unenriched" | d$Food_long == "Yogurt, plain, whole milk" | d$Food_long == "Soymilk, original and vanilla, unfortified" | d$Food_long == "Cottage cheese, farmer's (low-fat)", d$eaa_E, d$eaa)
...
d$F <- ifelse(d$Food_long == "Milk (cow), dry, whole, without added vitamin D" | d$Food_long == "Milk (cow), whole, 3.25% milkfat, without added vitamin A and vitamin D" | d$Food_long == "Milk, sheep/goat, fluid, whole, unenriched" | d$Food_long == "Yogurt, plain, whole milk" | d$Food_long == "Soymilk, original and vanilla, unfortified" | d$Food_long == "Cottage cheese, farmer's (low-fat)", d$F_E, d$F)
...
write.csv(d, "Data/NVS_4Mar2024.csv", row.names = F)
...
write.csv(d, "Data/NVS_nFU_4Mar2024.csv", row.names = F)
